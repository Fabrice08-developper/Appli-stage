...
<body>
    <div class="container">
        ...
        <div class="img d-flex justify-content-center">
            <a href="#" style="text-decoration: none;"><i class="fa-solid fa-arrow-left" style="color: black;"><h2>Mon profil</h2></i></a>
            <img src="images/OIP-removebg-preview.png" alt="" style="width: 80px; height: auto;">
        </div>
        <div class="card">
            <div class="card-body">
                <i class="fa-solid fa-user"></i><h5 class="card-title">Nom d'administrateur: <?php echo $_SESSION['nom2']; ?></h5>
                <i class="fa-solid fa-envelope"></i><p class="card-text">Email: <?php echo $_SESSION['email2']; ?></p>
